...
public final class ExtraBaggageFieldsFactory
    extends ExtraFactory<ExtraBaggageFields, ExtraBaggageFieldsFactory> {
  public static final int MAX_DYNAMIC_FIELDS = Long.SIZE;

  public static ExtraBaggageFieldsFactory newFactory(List<BaggageField> fields, boolean dynamic) {
    ...
    return new ExtraBaggageFieldsFactory(array, initialFieldIndices, dynamic);
  }
  ...
  @Override public ExtraBaggageFields create() {
    return new ExtraBaggageFields(this);
  }
}
