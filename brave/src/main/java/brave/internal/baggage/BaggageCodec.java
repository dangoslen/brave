...
public interface BaggageCodec {
   ...
   *
   * @param values holds all {@linkplain BaggageField baggage fields} and with {@code null} values
   * @return an input to {@link Setter#put(Object, Object, String)}
   * @see #injectKeyNames()
   */
  @Nullable
  String encode(Map<BaggageField, String> values, TraceContext context, Object request);
}
